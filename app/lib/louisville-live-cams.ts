...
const KNOWN_LIVE_CAMS: KnownLiveCam[] = [
  ...
  // https://www.corvettemuseum.org/live-stream/
  {
    ...
    title: 'National Corvette Museum · Corvette Boulevard',
    description:
      'Live National Corvette Museum camera looking across Corvette Boulevard in Bowling Green.',
    latitude: 37.0042,
    longitude: -86.3745,
    source: 'National Corvette Museum',
    embedUrl: 'https://console.rhombussystems.com/share/live/WRcwhIJASv2c4WSnmJqLBQ',
  },
  {
    id: 'bg-corvette-main-circle',
    cityId: 'bowling-green',
    title: 'National Corvette Museum · Main Circle',
    description: 'Live National Corvette Museum camera at the main circle entrance.',
    latitude: 37.0043,
    longitude: -86.3744,
    source: 'National Corvette Museum',
    embedUrl: 'https://console.rhombussystems.com/share/live/xLM_6QyQQimlvwLH7lN6iA',
  },
  {
    id: 'bg-corvette-delivery-1',
    cityId: 'bowling-green',
    title: 'National Corvette Museum · Delivery 1',
    description: 'Live R8C Corvette delivery camera inside the National Corvette Museum.',
    latitude: 37.004,
    longitude: -86.3742,
    source: 'National Corvette Museum',
    embedUrl: 'https://console.rhombussystems.com/share/live/q49dEGfESK--HeVjWzTdnQ',
  },
  {
    id: 'bg-corvette-delivery-2',
    cityId: 'bowling-green',
    title: 'National Corvette Museum · Delivery 2',
    description: 'Live R8C Corvette delivery camera inside the National Corvette Museum.',
    latitude: 37.004,
    longitude: -86.3741,
    source: 'National Corvette Museum',
    embedUrl: 'https://console.rhombus.com/share/live/T5PWWLKoQGq0LJX4ya2Uvw',
  },
  {
    id: 'bg-corvette-delivery-3',
    cityId: 'bowling-green',
    title: 'National Corvette Museum · Delivery 3',
    description: 'Live R8C Corvette delivery camera inside the National Corvette Museum.',
    latitude: 37.0041,
    longitude: -86.374,
    source: 'National Corvette Museum',
    embedUrl: 'https://console.rhombussystems.com/share/live/vo5pXOUEQMm9BPSrJyWFqA',
  },
  {
    id: 'bg-corvette-delivery-4',
    cityId: 'bowling-green',
    title: 'National Corvette Museum · Delivery 4',
    description: 'Live R8C Corvette delivery camera inside the National Corvette Museum.',
    latitude: 37.0041,
    longitude: -86.3739,
    source: 'National Corvette Museum',
    embedUrl: 'https://console.rhombussystems.com/share/live/BlbQAUCUSSuvcY7WiTUUgw',
  },
  {
    id: 'bg-corvette-delivery-5',
    cityId: 'bowling-green',
    title: 'National Corvette Museum · Delivery 5',
    description: 'Live R8C Corvette delivery camera inside the National Corvette Museum.',
    latitude: 37.0042,
    longitude: -86.3738,
    source: 'National Corvette Museum',
    embedUrl: 'https://console.rhombussystems.com/share/live/y01fzhO0Th2U_qtiZwKvEg',
  },
  {
    id: 'bg-corvette-delivery-6',
    cityId: 'bowling-green',
    title: 'National Corvette Museum · Delivery 6',
    description: 'Live R8C Corvette delivery camera inside the National Corvette Museum.',
    latitude: 37.0042,
    longitude: -86.3737,
    source: 'National Corvette Museum',
    embedUrl: 'https://console.rhombussystems.com/share/live/jZOE_w1vTaSNqIag2iNaAw',
  },
  {
    id: 'bg-corvette-delivery-7',
    cityId: 'bowling-green',
    title: 'National Corvette Museum · Delivery 7',
    description: 'Live R8C Corvette delivery camera inside the National Corvette Museum.',
    latitude: 37.0043,
    longitude: -86.3736,
    source: 'National Corvette Museum',
    embedUrl: 'https://console.rhombussystems.com/share/live/7fEtA4MTSLyvjq_RNfKMdQ',
  },
  {
    id: 'bg-corvette-delivery-8',
    cityId: 'bowling-green',
    title: 'National Corvette Museum · Delivery 8',
    description: 'Live R8C Corvette delivery camera inside the National Corvette Museum.',
    latitude: 37.0043,
    longitude: -86.3735,
    source: 'National Corvette Museum',
    embedUrl: 'https://console.rhombussystems.com/share/live/6iujXpS3RhK9Qmamde6PVg',
  },
  {
    id: 'bg-corvette-plant-approach-ky446',
    cityId: 'bowling-green',
    title: 'Corvette plant approach · KY 446 at US 31W',
    description:
      'KYTC camera by the National Corvette Museum and GM Bowling Green Assembly Plant approach.',
    latitude: 37.0086,
    longitude: -86.3768,
    source: 'KYTC cameras',
    mediaUrl: 'http://www.trimarc.org/images/milestone/CCTV_03_KY446_0002.jpg',
  },
